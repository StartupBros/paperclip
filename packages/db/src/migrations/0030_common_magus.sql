...
--> statement-breakpoint
ALTER TABLE "companies" ADD COLUMN "execution_policy" jsonb;--> statement-breakpoint
ALTER TABLE "heartbeat_runs" ADD COLUMN "failure_category" text;--> statement-breakpoint
ALTER TABLE "heartbeat_runs" ADD COLUMN "retry_of_run_id" uuid;--> statement-breakpoint
ALTER TABLE "heartbeat_runs" ADD COLUMN "retry_ordinal" integer DEFAULT 0 NOT NULL;--> statement-breakpoint
ALTER TABLE "heartbeat_runs" ADD COLUMN "resolved_execution_target" jsonb;--> statement-breakpoint
ALTER TABLE "heartbeat_runs" ADD COLUMN "resolved_execution_source" text;--> statement-breakpoint
