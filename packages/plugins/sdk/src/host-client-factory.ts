...
export interface HostServices {
  ...
  /** Provides `projects.list`, `projects.get`, `projects.listWorkspaces`, `projects.getPrimaryWorkspace`. */
  projects: {
  ...
  /** Provides `agents.list`, `agents.get`, `agents.invoke`, `agents.pause`, `agents.resume`. */
  agents: {
